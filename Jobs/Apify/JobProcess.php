...
use App\Services\Apify\ApifyJobSyncService;
...
class JobProcess implements ShouldQueue, ShouldBeUnique
{
     ...
     * Execute the job.
     */
    public function handle(Client $client, ApifyJobSyncService $apifyJobSyncService): void
    {
        $apifyJobSyncService->sync($this->apifyJob->fresh(), $client);
    }
}
